...
class Character extends FlxSprite
{
	...
	public var playAnimFrameCooldown:Bool = false;
	...
	override function update(elapsed:Float)
	{
		...
		if (playAnimFrameCooldown)
			playAnimFrameCooldown = false;
	}
	...
	{
		if (playAnimFrameCooldown && AnimName.contains('sing'))
			return;
		specialAnim = false;
		animation.play(AnimName, Force, Reversed, Frame);

		if (AnimName.contains('sing'))
			playAnimFrameCooldown = true;
